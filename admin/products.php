...
<!-- HIDDEN COLOR CHANGER -->      
  	...
  	<!--LOGO-->
	<div class="grid_8" id="logo">Admin</div>
    <div class="grid_8">
<!-- USER TOOLS START -->
...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item last" id="eight"><a href="#" class="main current"><span class="outer"><span class="inner settings">Movie_details</span></span></a></li>        
    </ul>
</div>
<!-- MENU END -->
</div>
