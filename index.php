...
<div id="leftSide">
	...
	<ul>
			<li style="border-bottom: 1px solid rgba(127, 127, 127, 0.3); position: relative;"><a href="store/generatetrans.php" style="color: #211C1B; display: block; font-family: 'Oswald',Arial; font-weight: 600; padding: 10px 25px; text-decoration: none; text-transform: uppercase; font-size:15px;">Book Movie</a></li>
		</ul>
    <nav id="sidebarmenu">
		...
		<br/><br/><br/>
		<a href="maps.html" target=blank>Contact Us</a><br/>
		<a href="mail.php" target=blank>Mail Us</a>
    </nav>
...
<li id="page_about">
    ...
    <p style="text-align:justify;">
		Book Movie !! and enjoy with your family!!
...
<li id="page_gallery">
    ...
    <ul class="splitter" id="filter">
        ...
        <ul>
            ...
            <li class="segment-0"><a href="#" data-value="non_veg">Fiction</a></li>
            <li class="segment-2"><a href="#" data-value="veg">Drama</a></li>
            <li class="segment-3"><a href="#" data-value="drinks">Comedy</a></li>
			<li class="segment-4"><a href="#" data-value="tshirt">Thriller</a></li>
        </ul>
        </li>
    </ul>
    </div>
    <div class="image_grid">
        <ul id="list" class="portfolio_list">
            <li data-id="id-1" class="non_veg">
                    ...
                    <img src="images/4.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-1" class="non_veg">
                
                    <span class="roll"></span>
                    <img src="images/2.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-1" class="non_veg">
                
                    <span class="roll"></span>
                    <img src="images/3.jpg" alt="img" class="img_bor" />
            </li>
			<li data-id="id-1" class="non_veg">
			...
			<li data-id="id-1" class="non_veg">
                    ...
                    <span class="roll"></span>
                    <img src="images/5.jpg" alt="img" class="img_bor" />
            </li>
			
			
            <li data-id="id-4" class="veg">
                    <span class="roll"></span>
                    <img src="images/1.jpg" alt="img" class="img_bor" />
            </li>
